...
import 'dart:io';
import 'dart:math';
import 'package:explore_now/features/daily_check_in/screens/home/models/location_model.dart';
...
class LocationService {
  ...
  Future<List<Location>> fetchLocations() async {
    ...
    final response = await ioClient.get(Uri.parse('${TConnectionStrings.deployment}location'));
    // Print the response body to see what the API is returning
    print('API Response: ${response.body}');
    if (response.statusCode == 200) {
      final data = json.decode(response.body);
      // Ensure that the 'results' key exists and contains a list
